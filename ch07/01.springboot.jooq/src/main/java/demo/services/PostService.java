...
import static demo.jooq.domain.tables.Comments.COMMENTS;
import static demo.jooq.domain.tables.Posts.POSTS;
...
public class PostService {
	...
	public Post getPost(Integer postId) {
		...
		if (record != null) {
			...
			Result<Record> commentRecords = dsl.select().from(COMMENTS)
