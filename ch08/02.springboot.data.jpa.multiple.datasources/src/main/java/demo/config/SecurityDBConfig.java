...
@Configuration
@EnableJpaRepositories(basePackages = "demo.security.repositories", entityManagerFactoryRef = "securityEntityManagerFactory", transactionManagerRef = "securityTransactionManager")
public class SecurityDBConfig {
	...
	public LocalContainerEntityManagerFactoryBean securityEntityManagerFactory() {
		...
		factory.setPackagesToScan("demo.security.entities");
